<%@ Page Title="" Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="RepeaterExample.aspx.cs" Inherits="WebFormsApp.RepeaterExample" %>
            ...
            <asp:Repeater runat="server" ID="rgallery">
                ...
                <ItemTemplate>
                    ...
                    <div class="col-md-4" style="">
                        ...
                        <asp:Image runat="server" Style="width: 50%" ImageUrl='<%# Eval("ImagePath") %>' />
